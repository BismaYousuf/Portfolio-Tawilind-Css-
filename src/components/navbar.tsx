    ...
    return (
        <>
            <div className="text-white/70 pt-6">
                    ...
                    <ul className="flex flex-row p-4 space-x-8">
                        {navLinks.map((link, index) => (
                            <li key={index} className="group">
                                <Link href={link.path}>
                                    <p className="text-white/70 hover:text-white transition duration-300 ease-in-out cursor-pointer">
                                        {link.title}
                                    </p>
                                    <div className="w-0 h-1 bg-orange-400 transition-all duration-300 ease-in-out group-hover:w-full"></div>
                                </Link>
                            </li>
                        ))}
                        <li>
                            <a href="#contact" className="group">
                                <h1 className="text-large font-bold text-white/70 cursor-pointer">
                                    Contact Me
                                </h1>
                ...
                <div
                    onClick={toggleNav}
                    className="md:hidden absolute top-5 right-5 border text-white/70 rounded border-white/70 p-2 z-50"
                >
